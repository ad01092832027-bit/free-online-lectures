...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.chizi.data_usage.DataUsagePlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin data_usage, com.chizi.data_usage.DataUsagePlugin", e);
    }
    try {
